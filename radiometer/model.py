...
class Radiometer:
    ...
    def _calculate_radiation_components(self):
        ...
        # Longwave up calculated using the Stefan-Boltzmann law
        # Assume surface temperature is equal to air temperature
        stefan_boltzmann_constant = 5.67e-8
        surface_emissivity = 0.98
        self.longwave_up = surface_emissivity * stefan_boltzmann_constant * (self.air_temperature + 273.15)**4
